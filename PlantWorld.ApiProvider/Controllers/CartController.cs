...
// المستخدم يملأ الكارت ==> يدوس اطلب ==> يروح لصفحة Checkout
//  صفحة Checkout بتعرض ملخص الطلب (المنتجات، الكمية، السعر الكلي)
//  المستخدم يملأ بيانات الشحن والدفع   ==> يضغط تأكيد الطلب
//  نفرغ الكارت بعد تأكيد الطلب

// الفرونت يبعت سيشن آي دي مع كل طلب للكارت والشيك آوت ==> بيانات المستخدم محفوظة في السيشن آي دي ده
// أي بي آي تجيب كارت ايتمز بناء على السيشن آي دي ده
// لو الكارت فاضي، المستخدم ميقدرش يروح للشيك آوت
// ولو مليان تعمل تشيك آوت ==> تنقل كارت لاوردر ايتمز ==> تحسب السعر الكلي ==> تحفظ اوردر في الداتا بيز ==> تفرغ الكارت